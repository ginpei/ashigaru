...
import { createEditorPageState, EditorPageState, getEditingNote, updateEditingNote } from "./EditorPageState";

const EditorPageContext = createContext<[EditorPageState, Dispatch<SetStateAction<EditorPageState>>]>([createEditorPageState(), () => undefined])
